...
def client_setup_teardown():
    ...
    insta4288.app.config["TESTING"] = True
    ...
    with insta4288.app.test_client() as client:
        yield client
...
def db_setup_teardown():
    """Connect to insta4288's sqlite database."""
    db_connection = sqlite3.connect("var/insta4288.sqlite3")
